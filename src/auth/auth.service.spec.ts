...
// import { CreateConsumerAuthDto } from './dto/create-user.dto';
...
//     await expect(authService.findUserById(userId)).rejects.toThrow(errorMessage);
//     expect(mockUserService.findUserbyId).toHaveBeenCalledWith(userId);
//   });
...
//     const result = await authService.createEmployee(queryRunner, dto);
